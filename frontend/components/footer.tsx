...
export default function Footer() {
  ...
  return (
    <footer className="pt-10 bg-primary-black">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          <div className="text-gray-300 group transition duration-500"><a href="https://links-sadmanyasar.netlify.app/" target="_blank">© 2023 Sadman Yasar Sayem.</a> <span>Images taken from <a href="https://www.freepik.com/free-photos-vectors/ai-generated" target="_blank">Freepik</a></span>. <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-white"></span> </div>
          <div className="flex items-center gap-x-6 text-gray-400 mt-6">
            <a href="https://links-sadmanyasar.netlify.app/" target="_blank">
